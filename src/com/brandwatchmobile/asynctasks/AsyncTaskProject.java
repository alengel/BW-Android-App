...
import com.brandwatchmobile.jsonparsers.JsonProjectParser;
...
public final class AsyncTaskProject extends AsyncTask<HttpRequestParameters, Boolean , List<ListItem> > 
{
	...
	public AsyncTaskProject(AsyncTaskCallback callback, Activity context, String progressMessage)
	{
	...
	protected List<ListItem> doInBackground(HttpRequestParameters... params) 
	{
		...
		if(responseCode == HttpStatus.SC_OK)
		{
			try
			{
				...
				items = JsonProjectParser.parse(responseText);
			}
			catch (Exception e){}
		}
